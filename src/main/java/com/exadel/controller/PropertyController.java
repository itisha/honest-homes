...
import com.exadel.mongodb.PropertyRepository;
...
public class PropertyController {
    ...
    public ResponseEntity getAll() {
        return new ResponseEntity<List<Property>>(repository.findAll(), HttpStatus.OK);
    }

    @RequestMapping(value = "/id/{id}", method = RequestMethod.GET, produces = "application/json")
    public ResponseEntity findById(@PathVariable("id") String id) {
        return new ResponseEntity<Property>(repository.findOne(id), HttpStatus.OK);
    }
    ...
    public ResponseEntity findByLandlordId(@PathVariable("landlordId") String landlordId) {
        return new ResponseEntity<List<Property>>(repository.findByLandlordId(landlordId), HttpStatus.OK);
    }

    @RequestMapping(value = "/", method = RequestMethod.POST, produces = "application/json")
    public ResponseEntity create(@RequestBody Property property) {
        return new ResponseEntity<Property>(repository.save(property), HttpStatus.CREATED);
    }
